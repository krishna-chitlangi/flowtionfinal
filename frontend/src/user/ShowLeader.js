            ...
            <ul style={{ listStyle: 'none' }}>
                ...
                {data &&
                    data.map((a, i) => {
                        return (<div>
                            <li key={i}>
                                <div style={{ backgroundColor: '#131D5A', color: 'white', padding: '10px', textAlign: 'center', marginLeft: '80px', fontSize: '30px', height: '70px', borderRadius: '10px' }} >{a.name} | {a.time} seconds</div></li><br></br></div>)
