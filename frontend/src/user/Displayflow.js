    ...
    return (<div>
        ...
        <div style={{ backgroundColor: 'rgba(5,0,255,0.4)' }}>
            ...
            <div style={{ display: 'flex' }}>
                ...
                {!button &&
                    <button style={{ backgroundColor: '#131D5A', marginRight: '260px', color: 'white', padding: '10px', textAlign: 'center', marginLeft: '13%', width: '200px', height: '60px', borderRadius: '40px' }} onClick={buttonHandler}>Show Hint</button>
                }
