                    ...
                    <div style={{ width: '100%', display: 'flex' }}>
                        {
                            ...
                            categories && categories.map((fc, i) => {
                                return (<div key={i}>
                                    <button style={{ backgroundColor: '#131D5A', color: 'white', padding: '10px', textAlign: 'center', marginLeft: '80px', fontSize: '30px', height: '100px', borderRadius: '10px' }} key={i} value={fc} onClick={(e) => handleClick(e)} >
                                        {fc}
                                    </button>
                                    <br></br>
                                    <br></br>
